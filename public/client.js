...
// 	}else if('default' == localStorage.theme){
...
$('#themeSelect').on('change', function(){
  ...
  $.post('/changeTheme', {theme:theme} , function(data){
  	console.log(data);
	});
...
document.onscroll = function(){
  ...
  console.log(file);
 		if(file.length > 0){
 			...
 			$("#postinput")[0].value = file;
 			$("#postinput")[0].style.textAlign = "right";
 			$("#postinput")[0].style.paddingRight = "35px";
 		}
	});
